...
def pivot_table(wb: object, ws1: object, pt_ws: object, ws_name: str, pt_name: str, pt_rows: list, pt_cols: list, pt_filters: list, pt_fields: list):
    ...
    pvt_beg = pt_ws.Cells(2,2)
    pvt_end = pt_ws.Cells(2,2)
    pvt_dest_rng = pt_ws.Range(pvt_beg, pvt_end)
    pc.CreatePivotTable(TableDestination=pvt_dest_rng, TableName=pt_name)
